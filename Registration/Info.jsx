...
export default function InfoSection({ navigation, route }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        status: motherData.status || "Active",
        district: motherData.district,
        sector: motherData.sector,
        cell: motherData.cell,
        village: motherData.village,
        notes: motherData.notes,
      };
      await motherAPI.createMother(payload);
      Alert.alert("Success", "Mother registered successfully.", [
        {
          text: "OK",
